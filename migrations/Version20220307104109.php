 ...
 */
final class Version20220307104109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE date (id DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE date_reservation (date_id DATE NOT NULL, reservation_id INT NOT NULL, INDEX IDX_7DB17C89B897366B (date_id), INDEX IDX_7DB17C89B83297E7 (reservation_id), PRIMARY KEY(date_id, reservation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, nombre_place INT NOT NULL, date_arrivee DATE NOT NULL, date_depart DATE NOT NULL, date_reservation DATE NOT NULL, code_acces INT DEFAULT NULL, INDEX IDX_42C8495519EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
